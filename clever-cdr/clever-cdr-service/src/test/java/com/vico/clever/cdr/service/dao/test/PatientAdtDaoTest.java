...
//			logger.debug("*********  patientAdmission Inserted  ***********");
			...
			String patientID="M000497439";
			String visitId="1519786";
			PatientDischargeInfo patDischargeInfo=patientAdtDao.selectPatientDischargeInfo(patientID, visitId);
			logger.debug(patDischargeInfo.toString());
			sqlSession.commit();
