...
public class DrugDispensingReq {
	private String medicationID;// 药嘱ID(*)
	private String patientID;// 病人ID(*)
	private String visitID;// 就诊ID(*)
	private String drugDispensingReqID;// 摆药申请单号(*)
	private String emergency;// 紧急摆药属性(*),0-普通，1-紧急，默认为0
	private String destinationPharmacyName;// 发往药房名称
	private String destinationPharmacyCode;// 发往药房代码
	private String reqDispensingAmount;// 申请摆药量
	private String reqDispensingAmountUnit;// 申请摆药量单位
	private String receiveDispensingAmount;// 实际摆药量
	private String receiveDispensingAmountUnit;// 实际摆药量单位
	private String medicineTradeName;// 所摆药品的商品名
	private String apprpvalNumber;// 所摆药品的批准文号
	private String manufacturer;// 所摆药品的生产厂家
	private String batchID;// 所摆药品的生产批号
	private String reqDeptCode;// 摆药申请科室代码
	private String reqDeptName;// 摆药申请科室名称
	private String reqWardCode;// 摆药申请病区代码
	private String reqWardName;// 摆药申请病区名称
