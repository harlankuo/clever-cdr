...
public class DiagnosisNonHodgkinLymphoma {
	...
	private String pathologicalSubType;//病理亚型
	...
	private String AaIPIScore;//aaIPI评分
	...
	public String getPathologicalSubType() {
		return pathologicalSubType;
	}
	public void setPathologicalSubType(String pathologicalSubType) {
		this.pathologicalSubType = pathologicalSubType;
	}
	...
	public String getAaIPIScore() {
		return AaIPIScore;
	}
	public void setAaIPIScore(String aaIPIScore) {
		AaIPIScore = aaIPIScore;
	}
