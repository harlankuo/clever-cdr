...
@XmlRootElement(name = "ManagementAction")
public class ManagementAction {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ManagementAction other = (ManagementAction) obj;
	...
	public String toString() {
		return "ManagementAction [patientID=" + patientID + ", visitID="
				+ visitID + ", managementID=" + managementID
