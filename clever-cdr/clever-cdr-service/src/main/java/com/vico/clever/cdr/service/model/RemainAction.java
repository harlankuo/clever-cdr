...
@XmlRootElement(name = "RemainAction")
public class RemainAction {
	private String patientID;// 病人号(*)
	private String visitID;// 就诊号(*)
	private String requestID;// 其它医嘱申请号(*)
	private String orderContent;// 其它医嘱内容
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((orderContent == null) ? 0 : orderContent.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RemainAction other = (RemainAction) obj;
		...
		if (orderContent == null) {
			if (other.orderContent != null)
				return false;
		} else if (!orderContent.equals(other.orderContent))
			return false;
		if (patientID == null) {
	...
	public String toString() {
		return "RemainAction [patientID=" + patientID + ", visitID=" + visitID
				+ ", requestID=" + requestID + ", orderContent=" + orderContent
