...
@XmlRootElement(name = "DietAction")
public class DietAction {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DietAction other = (DietAction) obj;
	...
	public String toString() {
		return "DietAction [patientID=" + patientID + ", visitID=" + visitID
				+ ", dietID=" + dietID + ", dietContent=" + dietContent
