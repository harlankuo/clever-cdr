...
@XmlRootElement(name = "TherapyAction")
public class TherapyAction {
	private String patientID;// 病人号(*)
	private String visitID;// 就诊号(*)
	private String therapyID;// 治疗申请号(*)
	private String therapyContent;// 治疗内容
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((therapyContent == null) ? 0 : therapyContent.hashCode());
		result = prime * result
				+ ((therapyID == null) ? 0 : therapyID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TherapyAction other = (TherapyAction) obj;
		...
		if (performerName == null) {
			...
			return false;
		if (therapyContent == null) {
			if (other.therapyContent != null)
				return false;
		} else if (!therapyContent.equals(other.therapyContent))
			return false;
		if (therapyID == null) {
			if (other.therapyID != null)
				return false;
		} else if (!therapyID.equals(other.therapyID))
			return false;
		if (visitID == null) {
	...
	public String toString() {
		return "TherapyAction [patientID=" + patientID + ", visitID=" + visitID
				+ ", therapyID=" + therapyID + ", therapyContent="
				+ therapyContent + ", curStateCode=" + curStateCode
