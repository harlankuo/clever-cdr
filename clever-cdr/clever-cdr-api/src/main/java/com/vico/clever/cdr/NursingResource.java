...
public class NursingResource {
    ...
    /**
   	 ...
   	 * 
   	 * Method handling the data entry of nursing information into CDR with HTTP POST requests.
   	 * 
   	 * @author Yuan.Ziyang
    ...
    /**
   	 ...
   	 * 
   	 * Method handling the data entry of nursingAction information into CDR with HTTP POST requests.
   	 * 
   	 * @author Yuan.Ziyang
   	 * @param nursingAction
   	 *            input json or xml object data that contains NursingAction info;
   	 * @return IntegrationResult that contains the handling result description
   	 *         as an application/json response.
   	 */    
    @POST
